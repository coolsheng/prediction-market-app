...
interface PredictionResponse {
  ...
  alternative_outcomes_considered: string[];
  timestamp: number;
  model: string;
}
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const makeRequest = async (): Promise<Response> => {
        return fetch(`${backendUrl}/lambda-url/bootstrap`, {
          method: 'POST',
          headers: {
          ...
          {error ? (
            ...
            <View style={styles.responseCard}>
              ...
              <View style={styles.section}>
                ...
                <Text style={styles.infoText}>{response.market_type}</Text>
              </View>

              {/* Selected Outcome */}
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Selected Outcome</Text>
                <Text style={styles.infoText}>{response.selected_outcome}</Text>
              </View>

              {/* Prediction */}
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Prediction</Text>
                <Text style={styles.infoText}>{response.prediction}</Text>
              </View>

              {/* Recommended Buy */}
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Recommended Buy</Text>
                <Text style={styles.infoText}>{response.recommended_buy}</Text>
              </View>

              {/* Market vs Data Divergence */}
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Market vs Data Divergence</Text>
                <Text style={styles.infoText}>{response.data_vs_market_divergence}</Text>
              </View>
              ...
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Market Sentiment Note</Text>
                <Text style={styles.infoText}>{response.market_sentiment_note}</Text>
              </View>
              ...
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Alternative Outcomes Considered</Text>
                {response.alternative_outcomes_considered.map((outcome, index) => (
                  <View key={index} style={styles.bulletItem}>
                    <Text style={styles.bullet}>•</Text>
